...
const fashionCampaigns = [
  {
    ...
    subtitle: "Limited Edition Eveningwear & Bespoke Accessories",
    ...
    <div className="relative min-h-screen w-full flex flex-col bg-[#0A0A0A] text-[#F3F4F6] font-sans antialiased selection:bg-[#EAB308]/25 selection:text-[#FDE047] overflow-x-hidden">
      ...
      <header className="relative z-40 w-full border-b border-white/5 bg-[#0A0A0A]/85 backdrop-blur-md px-6 py-4 sm:px-10 lg:px-16 flex items-center justify-between">
        <div className="flex items-center gap-8">
          {/* Brand Logo & Monogram */}
          <Link to="/" className="group flex items-center gap-3 transition duration-300">
      ...
      <main className="relative z-10 flex-1 flex flex-col lg:flex-row w-full">
          ...
          <div className="relative z-10 mt-auto pt-8">
            ...
            <div className="mt-8 grid grid-cols-2 gap-3 max-w-lg">
              <div className="rounded-xl bg-[#111111]/75 backdrop-blur-md p-3.5 border border-white/5 hover:border-[#EAB308]/30 transition duration-300">
                ...
                <p className="mt-1 text-[11px] text-[#9CA3AF]">Your saved silhouettes & wishlist sync seamlessly across devices.</p>
              </div>
              ...
              <div className="rounded-xl bg-[#111111]/75 backdrop-blur-md p-3.5 border border-white/5 hover:border-[#EAB308]/30 transition duration-300">
                ...
                <p className="mt-1 text-[11px] text-[#9CA3AF]">End-to-end encrypted authentication & express atelier checkout.</p>
              </div>
            </div>
        ...
        {/* RIGHT COLUMN: Seamless Login Form with Ample Breathing Space */}
          ...
          <div className="relative z-10 w-full max-w-[480px]">
            ...
            <div className="mb-8 text-left">
              ...
              <p className="mt-2 text-sm text-[#9CA3AF] font-light leading-relaxed">
                Access your curated wardrobe, private collections, and seller atelier dashboard.
              </p>
            </div>
            ...
            {(successMessage || submittedSuccess) && (
              <div className="mb-6 rounded-xl bg-[#EAB308]/10 border border-[#EAB308]/40 p-4 text-xs text-[#FEF08A] flex items-center gap-3 animate-fadeIn">
                ...
                <div>
                  <span className="font-semibold block">{successMessage || "Signed in successfully!"}</span>
                  <span className="text-[#D1D5DB] text-[11px]">Redirecting to your atelier...</span>
                </div>
              </div>
            )}
              ...
              <div>
                <div className="flex items-center justify-between mb-1.5">
                  ...
                  <a
                    ...
                    className="text-[11px] font-medium text-[#EAB308] hover:text-[#FDE047] transition underline decoration-[#EAB308]/30 underline-offset-2"
                  >
                    Forgot Password?
                  </a>
                </div>
                ...
                <label htmlFor="rememberMe" className="flex items-center gap-2.5 cursor-pointer select-none">
                  ...
                  <div
                    className={`h-4 w-4 rounded border flex items-center justify-center transition-all duration-200 ${
                      form.rememberMe
                        ? "bg-[#EAB308] border-[#EAB308] text-[#0A0A0A]"
                        : "bg-[#141414] border-[#52525B] hover:border-[#EAB308]/60"
                    }`}
                  >
                    {form.rememberMe && (
                      <svg className="w-3 h-3 stroke-[3] text-[#0A0A0A]" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
                      </svg>
                    )}
                  </div>
                  <span className="text-xs text-[#D1D5DB]">Remember this session</span>
                </label>
              </div>
